...
function validateEmail($email) {
  ...
  function validar(e) {
    ...
    else alert("ingreso " + e.target.value.trim() + ", es correcto!");
  }
}
...
function validate() {
  ...
  if (
    ...
    LinkedIn.toLowerCase().indexOf("linkedin.com") > 0
  ) {
  ...
  if (
    ...
    Github.toLowerCase().indexOf("github.com") > 0
  ) {
    $("#invalidGithub").hide();
...
function MostrarPostulantes() {
  $.ajax({
    ...
    for (var i = 0; i < data.length; i++) {
      html +=
        `<div class="col-lg-4 col-6 px-0 " id="ContenedorPadre" >
        <div class="card py-0 Paneles Selector">
          ...
          <div class="d-flex bd-highlight py-3 Paneles ">
            <div class="p-2 flex-shrink-2 align-items-center bd-highlight ">
              ...
              <canvas class=" rounded-circle mx-auto d-block postulante " title="${
                data[i].nombreyApellido
              } " data-userid="${JSON.stringify([
          i,
        ])}" width="75" height="75"></canvas>
 
                <div class="p-2 flex-shrink-1 d-inline-flex bd-highlight mt-2">
                <a class="${!data[i].gitHub ? "d-none" : ""}" href="${
          data[i].gitHub
        }">  <span data-feather="github"class="mr-2"></span>  </a>
                <a class="${!data[i].linkedIn ? "d-none" : ""}" href="${
          data[i].linkedIn
        }">  <span data-feather="linkedin"class="mr-2"></span>  </a>
                <a class="${!data[i].email ? "d-none" : ""}" href="mailto:${
          data[i].email
        }" >  <span data-feather="mail"  class="mr-2"></span> </a>
              ...
              <div class="row">
              <div class="col-md-8">
              <h4 class="my-0 py-0 text-primary NombrePostulante"><small>${
                data[i].nombreyApellido
              }</small></h4>
              </div>
              <div class="col-auto">
              <button class="btn btn-light btn-modificar-postulante" data-id-postulante="` +
        data[i].idPostulante +
        `" ><span class="text-primary" data-feather="edit-2"></span></button>
              </div>
              </div>
              
 
              
              <h6 class="my-1 py-0"><small><b>Rol:</b> ${
                data[i].rol
              } - <b>Equipo:</b> ${data[i].equipo || "N/A"}  </small></h6>
 
              <h6 class="my-1 py-0"><small><b>DNI:</b> ${
                data[i].dni
              }</small></h6>
              <h6 class="my-1 py-0"><small><b>Telefono:</b> ${
                data[i].telefono
              }</small></h6>
              
 
              <div class="infoCompleta Desplegable"
              <h6 class="my-1 py-0"><small><b>Calle:</b> ${
                data[i].domicilio.calle
              } ${data[i].domicilio.numeroCalle}</small></h6>
              <h6 class="my-1 py-0"><small><b>Departamento:</b> ${
                data[i].domicilio.departamento || "N/A"
              } - <b>Piso:</b>${data[i].domicilio.piso || "N/A"}</small></h6>
              <h6 class="my-1 py-0"><small><b>Localidad:</b> ${
                data[i].domicilio.localidad
              } </small></h6>
              <h6 class="my-1 py-0><small><b>Codigo Postal:</b>${
                data[i].domicilio.codigoPostal
              }</small><h6>
              <h6 class="my-1 py-0"><small><b>Provincia:</b> ${
                data[i].domicilio.provincia
              } </small></h6>
              <h6 class="my-1 py-0"><small><b>Pais:</b> ${
                data[i].domicilio.pais.descripcion
              } </small></h6>
...
$(document).ready(function () {
  $("#ContenedorPadreFicha").on(
    "click",
    "button.btn-modificar-postulante",
    function () {
