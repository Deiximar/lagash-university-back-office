$(document).ready(function () {
  ...
  $("#botonCrearEdicion").click(function () {
    ...
    $.ajax({
      ...
      $("#FechaInicio").val("");
      $("#FechaFin").val("");
      $("NumeroEdicion").val(""), $("#NumeroPostulante").val("");
      $("#Locacion").val("");
  ...
  function listarEdicionesActivas() {
    $.ajax({
      ...
      for (var i = 0; i < ediciones.length; i++) {
        html +=
          '<tr class="text-secondary tabla-ediciones-activas">' +
          "<td>" +
          ediciones[i].numeroEdicion +
          "</td>" +
          "<td>" +
          moment(ediciones[i].fechaInicio).format("DD-MM-YYYY") +
          "</td>" +
          "<td>" +
          moment(ediciones[i].fechaFin).format("DD-MM-YYYY") +
          "</td>" +
          "<td>" +
          ediciones[i].cantidadPostulantes +
          "</td>" +
          "<td>" +
          ediciones[i].locacion.nombre +
          "</td>" +
          '<td><button class="btn btn-light btn-modificar-edicion" data-id-edicion="' +
          ediciones[i].idEdicion +
          '"><span class="text-primary" data-feather="edit-2"></span></button>' +
          '<button class="btn btn-light btn-visualizar-edicion" data-id-edicion="' +
          ediciones[i].idEdicion +
          '"><span class="text-primary" data-feather="eye"></span></button></td>' +
          "</tr>";
      }
  ...
  //Modificar Edicion
  $("#tabla-ediciones-activas").on(
    "click",
    "tbody button.btn-modificar-edicion",
    function () {
      ...
      $.ajax({
        ...
        $("#FechaInicioEditar").val(
          moment(edicion.fechaInicio).format("DD-MM-YYYY")
        );
  ...
  $(
    "#NumeroPostulante, #NumeroPostulanteEditar, #NumeroEdicion, #NumeroEdicionEditar"
  ).on("input", function () {
  ...
  $("#tabla-ediciones-activas").on(
    "click",
    "tbody button.btn-visualizar-edicion",
    function () {
      var idEdicion = $(this).data("idEdicion");
